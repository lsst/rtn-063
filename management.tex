...
There is a one-to-one relation between a job sent to PanDA for execution and a bps submit yaml file.
...
\code{$\rm HSC/runs/PDR2/v24\_1\_0/DM-39132/step3$} contains entries from step3 processing of all 710 tracts in the PDR2 outputs. The order of the
